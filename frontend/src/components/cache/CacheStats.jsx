...
const TILES = [
  ...
  // #230: Partly cached (validation_failed) is its own tile in amber — matching
  // the "Partly cached · N%" card badge. The Failed tile is gone: 'failed' was a
  // job outcome the orchestrator no longer writes into games.status (cache
  // validation integrity, 2026-09-07).
  ['Partly cached', 'partial', 'text-amber-400'],
